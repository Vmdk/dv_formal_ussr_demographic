...
```{r}
DATA_PATH <- "./populationbycountry19802010millions.csv"
...
DATA_PATH_DUR <- "./API_SP.DYN.LE00.IN_DS2_en_csv_v2_10576744/API_SP.DYN.LE00.IN_DS2_en_csv_v2_10576744.csv"
...
#dfU <- df[df$X == "Ukraine",]df_reduced$date_str <- paste(df_reduced$dec,df_reduced$month,sep="0-")
...
```{r}
png(filename = "~/Desktop/UCU/dv/fin/test_plot.png",width = 500,height = 1000, units='mm', res = 300)
plot1
